...
_CONFIG_FOR_DOC = "JEPAGPT2Config"
...
class GPT2ForSequenceClassification(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.transformer = GPT2Model(config)
        ### muP: swap nn.Linear with MuReadout
        self.score = MuReadout(config.model_dims, self.num_labels, bias=False)
...
class GPT2JEPALMHeadModel(GPT2PreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"attn.masked_bias", r"attn.bias", r"lm_head.weight"]
    ...
    def mup_base_shapes(cls, filename=None, base_kwargs=None, delta_kwargs=None):
        if not hasattr(cls, '_mup_base_shapes'):
            ...
            base_config = JEPAGPT2Config(
                model_dims=144,
                **base_kwargs,
            )
            delta_config = JEPAGPT2Config(
                **delta_kwargs
            )
            base_model = GPT2JEPALMHeadModel(config=base_config)
            delta_model = GPT2JEPALMHeadModel(config=delta_config)
...
GPT2JEPALMHeadModel.register_for_auto_class("AutoModelForCausalLM")
AutoModel.register(JEPAGPT2Config, GPT2JEPALMHeadModel)
AutoModelForCausalLM.register(JEPAGPT2Config, GPT2JEPALMHeadModel)