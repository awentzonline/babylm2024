...
from babylm.models import GPT2DiffuserLMHeadModel, HFHolo, HFVan, VectorDiffuser, HRRDiffuser  # HACK: register my models
...
MODEL_CLASSES = {
    ...
    "gptdiff": (GPT2DiffuserLMHeadModel, GPT2Tokenizer),
}
